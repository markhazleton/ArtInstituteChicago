...
namespace ArtInstituteChicago.Demo.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionArtworks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionArtworks_CollectionId_ArtworkId",
                table: "CollectionArtworks",
                columns: new[] { "CollectionId", "ArtworkId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_ArtworkId",
                table: "Favorites",
                columns: new[] { "UserId", "ArtworkId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UserId_ArtworkId",
                table: "Reviews",
                columns: new[] { "UserId", "ArtworkId" },
                unique: true);
