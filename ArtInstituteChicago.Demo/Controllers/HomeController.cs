...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        try
        {
            ...
            var featuredArtworks = response?.Data?.Where(a => !string.IsNullOrEmpty(a.ImageId)).Take(6).ToList() ?? new List<ArtInstituteChicago.Client.Models.Collections.ArtWork>();
        ...
        catch (Exception ex)
        {
            ...
            return View(new List<ArtInstituteChicago.Client.Models.Collections.ArtWork>());
        }
    }
